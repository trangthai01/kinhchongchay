...
return [
    ...
    'image_sizes' => [
     ...
     'product_image_sizes' => [
        ...
        'image_oth_thumbnail' => [ // this key must start with 'image_'. This is what the DB column must be named
            'w' => 50, // width in pixels
            'h' => 66, //height
            'basic_key' => 'thumbnail', // same as the main key, but WITHOUT 'image_'.
            'name' => 'Thumbnail', // description, used in the admin panel
        ...
        'image_oth_thumbnail_1' => [ // this key must start with 'image_'. This is what the DB column must be named
            'w' => 50, // width in pixels
            'h' => 66, //height
            'basic_key' => 'thumbnail', // same as the main key, but WITHOUT 'image_'.
            'name' => 'Thumbnail', // description, used in the admin panel
        ...
        'image_oth_thumbnail_2' => [ // this key must start with 'image_'. This is what the DB column must be named
            'w' => 50, // width in pixels
            'h' => 66, //height
            'basic_key' => 'thumbnail', // same as the main key, but WITHOUT 'image_'.
            'name' => 'Thumbnail', // description, used in the admin panel
        ...
        'image_oth_thumbnail_3' => [ // this key must start with 'image_'. This is what the DB column must be named
            'w' => 50, // width in pixels
            'h' => 66, //height
            'basic_key' => 'thumbnail', // same as the main key, but WITHOUT 'image_'.
            'name' => 'Thumbnail', // description, used in the admin panel
    ...
    'comments' => [
        ...
        // default: built_in
        'type_of_comments_to_show' => CommentsService::COMMENT_TYPE_DISABLED,
