...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8">
        ...
        @else
            ...
            <meta name="description" content="Công ty TNHH Kính chống cháy Việt (Fire Glass) | Chuyên tư vấn - Thiết kế - Thi công kính chống cháy cao cấp | Hotline: Mr San 0981 520 850">
        @endif
        ...
        @else
            ...
            <meta property="og:description" content="Công ty TNHH Kính chống cháy Việt (Fire Glass) | Chuyên tư vấn - Thiết kế - Thi công kính chống cháy cao cấp | Hotline: Mr San 0981 520 850">
