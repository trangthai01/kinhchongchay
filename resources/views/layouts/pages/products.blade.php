            ...
            <div class="system-main__list">
                ...
                <div class="system-main__mask">
                    <div class="text-holder" style="text-align: left">
                        ...
                        <p style="height: 55px"><span style="background-color: rgb(51, 79, 161); font-family: Raleway; color: rgb(255, 255, 255); font-weight: 600; border-color: rgb(255, 255, 255); border-style: solid; border-width: 2px; padding: 10px 25px; border-radius: 80px;"> Kính chống cháy và chống bức xạ nhiệt EW</span></p>
