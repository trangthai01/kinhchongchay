...
class PostsController extends Controller
{
    ...
    public function index(string $categorySlug = null)
    {
        ...
        $latestProjects = $this->postsService->findLatestProjects();
        $latestPosts = $this->postsService->findLatestPosts();
    ...
    public function show(Request $request, string $postSlug): \Illuminate\View\View
    {
        ...
        //$relatedPosts = $this->postsService->findRelatedPosts($blogPost->id, $categories);
        //$otherPosts = $this->postsService->findOtherPosts($blogPost->id, $categories);
        $latestPosts = $this->postsService->findLatestPosts();
        $latestProjects = $this->postsService->findLatestProjects();
        return view(
            'blogetc::single_post',
