...
use WebDevEtc\BlogEtc\Scopes\BlogEtcPublishedScopePage;

/**
 * Class BlogEtcPost.
 */
class Page extends Model implements SearchResultInterface
{
    use Sluggable;
...
//        static::$authorNameResolver = config('blogetc.comments.user_field_for_author_name');
        ...
        static::addGlobalScope(new BlogEtcPublishedScopePage());
    }
    ...
    {
        if($this->isBlog() == "N"){
            return route('storyetc.single', $this->slug);
        }
...
//        }
    ...
    {
        $base_text_to_use = $this->meta_desc;
