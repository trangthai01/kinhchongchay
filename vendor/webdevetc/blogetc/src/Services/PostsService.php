...
//        return [$post, $remainingPhotos];
    ...
    {
        return $this->repository->findBySlugNoMessage($slug);
    }
    ...
    {
        return $this->repository->findRelatedPosts($id, $categories);
    }

    public function findOtherPosts(int $id, array $categories): Collection
    {
        return $this->repository->findOtherPosts($id, $categories);
    }

    public function findLatestPosts(): Collection
    {
        return $this->repository->findLatestPosts();
    }

    public function findLatestProjects(): Collection
    {
        return $this->repository->findLatestProjects();
    }
