...
@if( config("blogetc.use_wysiwyg") && config("blogetc.echo_html") && (in_array( Request::route()->getName() ,[ 'blogetc.admin.create_post' , 'blogetc.admin.edit_post', 'blogetc.admin.products.create', 'blogetc.admin.products.edit'  ])))
