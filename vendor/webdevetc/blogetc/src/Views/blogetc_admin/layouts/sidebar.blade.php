    ...
    <li class="list-group-item justify-content-between lh-condensed">
        <div>
            ...
            <div class="list-group ">
                ...
                <a href="{{ route('blogetc.admin.products.index') }}"
                   class="list-group-item list-group-item-action @if(Request::route()->getName() === 'blogetc.admin.products.index') active @endif  ">
                    <i class="fa fa-th fa-fw" aria-hidden="true"></i>
                    All Products
                </a>
                <a href="{{ route('blogetc.admin.products.create') }}"
                   class="list-group-item list-group-item-action  @if(Request::route()->getName() === 'blogetc.admin.products.create') active @endif">
                    <i class="fa fa-plus fa-fw" aria-hidden="true"></i>
                    Add Product
                </a>
            </div>
